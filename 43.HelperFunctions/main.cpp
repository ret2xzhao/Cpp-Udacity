...
Gameboard has a private member 'gameSpace[4][4]' that is a 4x4 array that accepts a char 
...
*the helper function 'fourInRow' checks every row, looking for four 'x's. When it 
 finds four x's in the same row, it returns a '1', otherwise it returns a '0'.
